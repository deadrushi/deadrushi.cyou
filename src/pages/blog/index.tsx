      ...
      <PageContent>
        <div className="flex h-full flex-col gap-6 text-sm">
          ...
          >
            {POSTS.length > 0 ? (
              POSTS.map((post, i) => (
                <div key={post.slug} className="post-box">
                  <BlogPostItem
                    ref={(el) => {
                      blogRefs[i] = el;
                    }}
              ...
              <>
                <div className="post-box bg-tertiary/10 border-tertiary/15 text-tertiary flex h-24 w-full items-center justify-center rounded-lg border border-dashed">
                  Nothing here... yet.
                </div>
              </>
            )}
